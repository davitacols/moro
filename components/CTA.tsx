...
export default function CTA() {
  ...
  return (
    <section id="contact" className="section-padding pt-6 sm:pt-8">
      <div className="section-container">
        <motion.div
          ...
          className="section-shell overflow-hidden bg-gradient-to-br from-[#261331] via-[#4a1d5f] to-[#7d3294] p-6 text-white sm:p-8 lg:p-12"
        >
          <div className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:gap-10">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-lg leading-relaxed text-white/[0.78] sm:mt-6 sm:text-xl">
            ...
            >
              <div className="rounded-[1.3rem] border border-white/[0.12] bg-white/[0.08] p-4 backdrop-blur-sm sm:rounded-[1.6rem] sm:p-5">
              ...
              <div className="rounded-[1.3rem] border border-white/[0.12] bg-white/[0.08] p-4 backdrop-blur-sm sm:rounded-[1.6rem] sm:p-5">
                ...
                <div className="mt-4 grid gap-5 lg:grid-cols-[minmax(0,0.34fr)_minmax(0,0.66fr)] lg:items-center">
                  <div className="image-frame relative min-h-[120px] bg-white p-4 sm:min-h-[160px]">
                    <Image
                  ...
                  <p className="min-w-0 text-base leading-relaxed text-white/[0.82] sm:text-lg">
